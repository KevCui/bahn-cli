...
@test "CHECK: find_trip()" {
    ...
    [ "${lines[2]}" = "2157-0230  04H33  Uelzen-Magdeburg-Neustadt      2302-0041  RE  4697" ]
    [ "${lines[3]}" = "2157-0230  04H33  Magdeburg-Neustadt-Berlin Hbf  0046-0230  RE  3143" ]
    [ "${lines[4]}" = "2234-0536  07H02  Hamburg Hbf-Hannover Hbf       2234-0056  ME 81643" ]
    [ "${lines[5]}" = "2234-0536  07H02  Hannover Hbf-Berlin Hbf        0240-0536  ICE  949" ]
    [ "${lines[6]}" = "2246-0536  06H50  Hamburg Hbf-Bremen Hbf         2246-2341  IC  2021" ]
    [ "${lines[7]}" = "2246-0536  06H50  Bremen Hbf-Hannover Hbf        0013-0140  RE  4445" ]
    [ "${lines[8]}" = "2246-0536  06H50  Hannover Hbf-Berlin Hbf        0240-0536  ICE  949" ]
}
